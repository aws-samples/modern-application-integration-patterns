...
curl -i --location --request POST 'https://jvovzhfha8.execute-api.eu-central-1.amazonaws.com/live/' --header 'Content-Type: application/json' --data-raw '{"feedback":" This is bad product"}'


curl -i --location --request POST 'https://jvovzhfha8.execute-api.eu-central-1.amazonaws.com/live/' --header 'Content-Type: application/json' --data-raw '{"feedback":" This is good product"}'
